...
public class ItemRepository {
    ...
    /*using JdbcTemplate.query(sql, rowMapper<>)*/
    public List<Item> getAllItems(){
        List<Item> items = template.query
        		("select id from item",(ResultSet ,rowNum)->new Item(ResultSet.getInt("id"),ResultSet.getString("name"),ResultSet.getString("category")));
        return items;
    }
